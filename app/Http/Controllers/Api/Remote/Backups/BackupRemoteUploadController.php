...
class BackupRemoteUploadController extends Controller
{
    ...
    public function __invoke(Request $request, string $backup): JsonResponse
    {
        ...
        if (empty($size)) {
            throw new BadRequestHttpException('Um parâmetro de consulta "size" não vazio deve ser fornecido.');
        }
        ...
        if (!is_null($backup->completed_at)) {
            throw new ConflictHttpException('Este backup já está em um estado completo.');
        }
