...
class DatabaseSettingsCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->output->note('O uso da conta "root" para conexões MySQL não é apenas altamente desaprovado, mas também não é permitido por este aplicativo. Você precisará ter criado um usuário MySQL para este software.');
        ...
        try {
            ...
            $this->output->error(sprintf('Não é possível conectar ao servidor MySQL usando as credenciais fornecidas. O erro retornado foi "%s".', $exception->getMessage()));
            ...
            if ($this->confirm('Volte e tente novamente?')) {
