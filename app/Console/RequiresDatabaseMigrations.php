...
| @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ |
|                                                                              |
|               Seu banco de dados não foi migrado corretamente!                  |
|                                                                              |
| @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ |</>

Você deve executar o seguinte comando para concluir a migração do seu banco de dados:

  <fg=green;options=bold>php artisan migrate --step --force</>

Você não poderá usar o Painel Pterodactyl como esperado sem corrigir o estado do seu
banco de dados executando o comando acima.
');
