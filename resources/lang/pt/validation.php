...
return [
    ...
    */
    ...
    'required_if' => 'O :attribute é um campo necessário quando :other é :value.',
    'required_unless' => 'O :attribute é um campo  necessário, a menos que :other está em :values.',
    'required_with' => 'O :attribute é um campo necessário quando :values está presente.',
    'required_with_all' => 'O :attribute é um campo necessário quando :values está presente.',
    'required_without' => 'O :attribute é um campo necessário quando :values não está presente.',
    'required_without_all' => 'O :attribute é um campo necessário quando nenhum dos :values estão presentes.',
