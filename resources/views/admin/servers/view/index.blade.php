                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td>UUID / ID do Contêiner Docker</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    /
                                    @if($server->swap === 0)
                                        <code data-toggle="tooltip" data-placement="top" title="Espaço de Troca">Não Definido</code>
                                    @elseif($server->swap === -1)
                                        <code data-toggle="tooltip" data-placement="top" title="Espaço de Troca">Ilimitado</code>
                                    @else
                                        <code data-toggle="tooltip" data-placement="top" title="Espaço de Troca"> {{ $server->swap }}MiB</code>
                                    @endif
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <span class="label label-default">Nenhum Alias Atribuído</span>
                                    @endif
                                </td>
                            </tr>
                        </table>
                    ...
                    @if(!$server->isInstalled())
                        <div class="col-sm-12">
                            <div class="small-box {{ (! $server->isInstalled()) ? 'bg-blue' : 'bg-maroon' }}">
                                <div class="inner">
                                    <h3 class="no-margin">{{ (! $server->isInstalled()) ? 'Instalando' : 'Falha na Instalação' }}</h3>
                                </div>
                            </div>
                        </div>
                    @endif
