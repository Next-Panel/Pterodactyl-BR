...
@section('title')
    Gerenciar Usuário: {{ $user->username }}
@endsection
...
<div class="row">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group no-margin-bottom">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">Deixe em branco para manter a senha deste usuário a mesma. O usuário não receberá nenhuma notificação se a senha for alterada.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-xs-12">
        <div class="box box-danger">
            ...
            <div class="box-body">
                <p class="no-margin">Não deve haver servidores associados a esta conta para que ela possa ser excluída.</p>
            </div>
            <div class="box-footer">
                <form action="{{ route('admin.users.view', $user->id) }}" method="POST">
                    {!! csrf_field() !!}
                    {!! method_field('DELETE') !!}
                    <input id="delete" type="submit" class="btn btn-sm btn-danger pull-right" {{ $user->servers->count() < 1 ?: 'disabled' }} value="Excluir Usuário" />
                </form>
            </div>
        </div>
    </div>
