...
@section('content-header')
    <h1>Criar Usuário<small>Adicione um Novo usuário ao sistema.</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Identidade</h3>
                </div>
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="name_first" class="control-label">Nome do Cliente</label>
                        <div>
                            <input type="text" autocomplete="off" name="name_first" value="{{ old('name_first') }}" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name_last" class="control-label">Sobrenome do Cliente</label>
                        <div>
                ...
                <div class="box-footer">
                    {!! csrf_field() !!}
                    <input type="submit" value="Criar Usuário" class="btn btn-success btn-sm">
                </div>
            </div>
        </div>
        <div class="col-md-6">
                ...
                <div class="box-body">
                    <div class="form-group col-md-12">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>Definir como 'Sim' concede ao usuário acesso administrativo total.</small></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="alert alert-info">
                        <p>Fornecer uma senha de usuário é opcional. E-mails de nEggs usuários solicitam que os usuários criem uma senha na primeira vez que fazem login. Se uma senha for fornecida aqui, você precisará encontrar um método diferente para fornecê-la ao usuário.</p>
                    </div>
    ...
    <script>$("#gen_pass_bttn").click(function (event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $("#gen_pass").html('<strong>Senha Gerada:</strong> ' + data).slideDown();
