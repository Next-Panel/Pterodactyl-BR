...
@section('content-header')
    <h1>Nests<small>Todos os Nests atualmente disponíveis neste sistema.</small></h1>
    <ol class="breadcrumb">
...
<div class="row">
    <div class="col-xs-12">
        <div class="alert alert-danger">
            Os Eggs são um recurso poderoso do Painel Pterodactyl que permitem extrema flexibilidade e configuração. Observe que, embora poderosos, modificar um Egg incorretamente pode facilmente quebrar seus servidores e causar mais problemas. Evite editar nossos Eggs padrão — aqueles fornecidos por <code>support@pterodactyl.io</code> — a menos que você tenha certeza absoluta do que está fazendo.
        </div>
    </div>
</div>
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Nests Configurados</h3>
                <div class="box-tools">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('admin.nests.egg.import') }}" enctype="multipart/form-data" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="pImportToNest">Nest Associado <span class="field-required"></span></label>
                        <div>
                            ...
                            <p class="small text-muted">Selecione o Nest ao qual este Egg será associado no menu suspenso. Se você deseja associá-lo a um Novo Nest, precisará criar esse Nest antes de continuar.</p>
                        </div>
                    </div>
                </div>
