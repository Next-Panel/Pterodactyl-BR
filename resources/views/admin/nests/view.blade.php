...
<div class="row">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>Este deve ser um nome de categoria descritivo que englobe todas as opções dentro do serviço.</small></p>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <div class="col-md-6">
        <div class="box">
            <div class="box-body">
                <div class="form-group">
                    <label class="control-label">ID do Nest</label>
                    <div>
                        <input type="text" readonly class="form-control" value="{{ $nest->id }}" />
                        <p class="text-muted small">Um ID exclusivo usado para identificação deste Nest internamente e através da API.</p>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">Um UUID que todos os servidores que usam esta opção são atribuídos para fins de identificação.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Eggs do Nest</h3>
            </div>
