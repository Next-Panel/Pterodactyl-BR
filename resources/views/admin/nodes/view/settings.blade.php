...
@section('title')
    {{ $node->name }}: Configurações
@endsection

@section('content-header')
    <h1>{{ $node->name }}<small>Configure as configurações do seu Node.</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="{{ route('admin.nodes.view.settings', $node->id) }}">Configurações</a></li>
    ...
    <div class="row">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>Limites de caracteres: <code>a-zA-Z0-9_.-</code> e <code>[Espaço]</code> (mínimo 1, máximo 100 caracteres).</small></p>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <p class="text-muted"><small>Por favor, insira o nome de domínio (e.g. <code>node.example.com</code>) a ser usado para conectar ao daemon. Um endereço IP só pode ser usado se você não estiver usando SSL para este Node.
                                <a tabindex="0" data-toggle="popover" data-trigger="focus" title="Por que eu preciso de um FQDN?" data-content="Para proteger as comunicações entre seu servidor e este Node, usamos SSL. Não podemos gerar um certificado SSL para endereços IP e, como tal, você precisará fornecer um FQDN.">Por quê?</a>
                            </small></p>
                    </div>
                    <div class="form-group col-xs-12">
                        <label class="form-label"><span class="label label-warning"><i class="fa fa-power-off"></i></span> Comunicar via SSL</label>
                        <div>
                    ...
                    <div class="form-group col-xs-12">
                        <label class="form-label"><span class="label label-warning"><i class="fa fa-power-off"></i></span> Atrás de Proxy</label>
                        <div>
                            <div class="radio radio-success radio-inline">
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <p class="text-muted small">Se o Node estiver marcado como 'Em Manutenção', os usuários não poderão acessar os servidores que estão neste Node.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="memory" class="control-label">Memória Total</label>
                            ...
                            <div class="form-group col-xs-6">
                                <label for="memory_overallocate" class="control-label">Superalocação</label>
                                <div class="input-group">
                        ...
                        <p class="text-muted small">Insira a quantidade total de memória disponível neste Node para alocação em servidores. Você também pode fornecer uma porcentagem que pode permitir a alocação de mais do que a memória definida.</p>
                    </div>
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="form-group col-xs-6">
                            ...
                            <div class="form-group col-xs-6">
                                <label for="disk_overallocate" class="control-label">Superalocação</label>
                                <div class="input-group">
                        ...
                        <p class="text-muted small">Insira a quantidade total de espaço em disco disponível neste Node para alocação de servidor. Você também pode fornecer uma porcentagem que determinará a quantidade de espaço em disco acima do limite definido para permitir.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="box">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-12">
                        <label for="disk_overallocate" class="control-label">Tamanho Máximo de Upload de Arquivo da Web</label>
                        <div class="input-group">
                            <input type="text" name="upload_size" class="form-control" value="{{ old('upload_size', $node->upload_size) }}"/>
                            <span class="input-group-addon">MiB</span>
                        </div>
                        <p class="text-muted"><small>Insira o tamanho máximo de arquivos que podem ser enviados através do gerenciador de arquivos baseado na web.</small></p>
                    </div>
                    <div class="col-xs-12">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p class="text-muted"><small>O daemon executa seu próprio contêiner de gerenciamento SFTP e não usa o processo SSHd no servidor físico principal. <Strong>Não use a mesma porta que você atribuiu para o processo SSH do seu servidor físico.</strong></small></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body row">
                    <div class="form-group col-sm-6">
                        ...
                        <p class="text-muted"><small>Redefinir a chave mestra do daemon invalidará qualquer solicitação vinda da chave antiga. Esta chave é usada para todas as operações confidenciais no daemon, incluindo criação e exclusão de servidores. Sugerimos alterar esta chave regularmente por segurança.</small></p>
                    </div>
                </div>
