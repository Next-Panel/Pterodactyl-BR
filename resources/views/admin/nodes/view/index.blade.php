        ...
        <div class="row">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            <tr>
                                ...
                                <td><code data-attr="info-version"><i class="fa fa-refresh fa-fw fa-spin"></i></code> (Mais recente: <code>{{ $version->getDaemon() }}</code>)</td>
                            </tr>
                            <tr>
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    <div class="box-header with-border">
                        <h3 class="box-title">Excluir Node</h3>
                    </div>
                    <div class="box-body">
                        <p class="no-margin">A exclusão de um Node é uma ação irreversível e removerá imediatamente este Node do painel. Não deve haver servidores associados a este Node para continuar.</p>
                    </div>
