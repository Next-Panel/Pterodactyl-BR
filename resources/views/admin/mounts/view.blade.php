...
@section('title')
    Montagens &rarr; Visualizar &rarr; {{ $mount->id }}
@endsection
...
@section('footer-scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#pEggs').select2({
                placeholder: 'Selecione os Eggs..',
            });

            $('#pNodes').select2({
                placeholder: 'Selecione os Nodes..',
            });
            ...
            $('button[data-action="detach-egg"]').click(function (event) {
                ...
                $.ajax({
                    ...
                    swal({ type: 'success', title: 'Egg desanexado.' });
                }).fail(function (jqXHR) {
                    console.error(jqXHR);
                    swal({
                        title: 'Opa!',
            ...
            $('button[data-action="detach-node"]').click(function (event) {
                ...
                $.ajax({
                    ...
                    element.parent().parent().addClass('warning').delay(100).fadeOut();
                    swal({ type: 'success', title: 'Node desanexado.' });
                }).fail(function (jqXHR) {
                    console.error(jqXHR);
                    swal({
                        title: 'Opa!',
