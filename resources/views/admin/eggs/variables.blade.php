...
@section('content-header')
    <h1>{{ $egg->name }}<small>Gerenciando variáveis para este Egg.</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="form-label">Variável de Ambiente</label>
                            ...
                            <div class="col-xs-12">
                                <p class="text-muted small">Esta variável pode ser acessada no comando de inicialização usando <code>{{ $variable->env_variable }}</code>.</p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Permissões</label>
                            <select name="options[]" class="pOptions form-control" multiple>
                                <option value="user_viewable" {{ (! $variable->user_viewable) ?: 'selected' }}>Usuários Podem Visualizar</option>
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-muted small">Estas regras são definidas usando as regras de validação padrão do <a href="https://laravel.com/docs/5.7/validation#available-validation-rules" target="_blank">Laravel Framework</a>.</p>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('admin.nests.egg.variables', $egg->id) }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label class="control-label">Variável de Ambiente <span class="field-required"></span></label>
                        ...
                        <div class="col-xs-12">
                            <p class="text-muted small">Esta variável pode ser acessada no comando de inicialização inserindo <code>@{{valor da variável de ambiente}}</code>.</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Permissões</label>
                        <select name="options[]" class="pOptions form-control" multiple>
                            <option value="user_viewable">Usuários Podem Visualizar</option>
                            <option value="user_editable">Usuários Podem Editar</option>
                        </select>
                    </div>
                    <div class="form-group">
...
@section('footer-scripts')
    ...
    <script>
        ...
        $('[data-action="delete"]').on('mouseenter', function (event) {
            $(this).find('i').html(' Excluir Variável');
