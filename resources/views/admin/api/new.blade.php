...
@section('content-header')
    <h1>API de Aplicação<small>Crie uma nova chave de API de aplicação.</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}">Administrador</a></li>
        <li><a href="{{ route('admin.api.index') }}">API de Aplicação</a></li>
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="form-group">
                            <label class="control-label" for="memoField">Descrição <span class="field-required"></span></label>
                            <input id="memoField" type="text" name="memo" class="form-control">
                        </div>
                        <p class="text-muted">Depois de atribuir permissões e criar este conjunto de credenciais, você não poderá voltar e editá-lo. Se precisar fazer alterações no futuro, você precisará criar um Novo conjunto de credenciais.</p>
                    </div>
