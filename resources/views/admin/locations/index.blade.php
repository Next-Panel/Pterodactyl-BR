...
@section('content-header')
    <h1>Localizações<small>Todas as localizações às quais os Nodes podem ser atribuídos para facilitar a categorização.</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#newLocationModal">Criar Nova</button>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <p class="text-muted small">Uma descrição mais longa desta localização. Deve ter menos de 191 caracteres.</p>
                        </div>
                    </div>
                </div>
