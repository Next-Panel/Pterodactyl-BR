                ...
                {!stats || isSuspended ? (
                    isSuspended ? (
                        <div css={tw`flex-1 text-center`}>
                            <span css={tw`bg-red-500 rounded px-2 py-1 text-red-100 text-xs`}>
                                {server.status === 'suspended' ? 'Suspenso' : 'Erro de conexão'}
                            </span>
                        </div>
                    ...
                    <React.Fragment>
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            ...
                            <p css={tw`text-xs text-neutral-600 text-center mt-1`}>de {cpuLimit}</p>
                        </div>
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                            ...
                            <p css={tw`text-xs text-neutral-600 text-center mt-1`}>de {memoryLimit}</p>
                        </div>
                        <div css={tw`flex-1 ml-4 sm:block hidden`}>
                            <div css={tw`flex justify-center`}>
                            ...
                            <p css={tw`text-xs text-neutral-600 text-center mt-1`}>de {diskLimit}</p>
                        </div>
                    </React.Fragment>
                )}
            </div>
