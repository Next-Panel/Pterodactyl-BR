    ...
    return (
        <>
            <Dialog.Confirm
                ...
                title={`Excluir ${file.isFile ? 'Arquivo' : 'Diretório'}`}
                confirm={'Excluir'}
            ...
            >
                ...
                {file.isArchiveType() ? (
                    <Can action={'file.create'}>
                        <Row onClick={doUnarchive} icon={faBoxOpen} title={'Desarquivar'} />
                    </Can>
                ) : (
                ...
                <Can action={'file.delete'}>
                    <Row onClick={() => setShowConfirmation(true)} icon={faTrashAlt} title={'Excluir'} $danger />
                </Can>
            </DropdownMenu>
        </>
    );
