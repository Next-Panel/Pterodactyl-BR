                    ...
                    {Object.keys(data.dockerImages).length > 1 && !isCustomImage ? (
                        <>
                            ...
                            <p css={tw`text-xs text-neutral-300 mt-2`}>
                                Este é um recurso avançado que permite selecionar uma imagem Docker para usar ao executar esta instância de servidor.
                            </p>
                        </>
                    ) : (
                        <>
                            ...
                            {isCustomImage && (
                                <p css={tw`text-xs text-neutral-300 mt-2`}>
                                    A imagem Docker deste servidor foi definida manualmente por um administrador e não pode ser alterada através desta interface.
                                </p>
                            )}
                        </>
                    )}
