...
export default ({ backup }: Props) => {
    ...
    return (
        <>
            ...
            >
                <p>
                    Seu servidor será interrompido. Você não será capaz de controlar o estado de energia, acessar o arquivo
                    ou crie backups adicionais até que seja concluído.
                </p>
