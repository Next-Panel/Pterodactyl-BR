...
const schema = object().shape({
    databaseName: string()
        .required('Um nome para o banco de dados deve ser fornecido.')
        ...
        .matches(
            /^[\w\-.]{3,48}$/,
            'O nome do banco de dados deve conter apenas caracteres alfanuméricos, sublinhados, traços e/ou pontos.'
        ),
